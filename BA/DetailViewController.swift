...
class DetailViewController: UITableViewController, HomeKitControllerDelegate, ContextHandlerDelegate {
    ...
    override func viewDidLoad() {
        ...
        center.addObserver(forName: NSNotification.Name(rawValue: "roomID"), object: contextHandler, queue: queue) { _ in
            self.loadData()
        }
    }
    ...
    func alertShowBeaconRoom (_ homeID: UUID, roomID: UUID, message: String) {
        ...
        alert.addAction(UIAlertAction(title: "Ja", style: UIAlertActionStyle.default) { _ in
                self.refreshControl!.beginRefreshing()
